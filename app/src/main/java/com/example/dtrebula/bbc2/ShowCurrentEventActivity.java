...
public class ShowCurrentEventActivity extends AppCompatActivity {
    ...
    private String eventNumberOfPeople = "", dateConversion = "", eventPeopleJoined = "", idOfUser = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new Session(ShowCurrentEventActivity.this);
        ...
        eventId = ShowEventActivity.returnEventId();
        ...
        backToEventsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowCurrentEventActivity.this, EventsActivity.class);
        ...
        logOffButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                logOff();
                Toast.makeText(ShowCurrentEventActivity.this, "You have been removed from the event!", Toast.LENGTH_SHORT).show();
            }
        });
        joinEventButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(checkJoinAvailable && dateCheckAvailable){
                    ...
                    addPeopleJoined();
                    retreiveCurrentEventInformation();
                    Toast.makeText(ShowCurrentEventActivity.this, "You Joined Event", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(ShowCurrentEventActivity.this, "Event uz je plny/ alebo " +
                            "ste nan uz prihlaseny/event sa uz konal, je nam luto", Toast.LENGTH_LONG).show();
                }
            }
        });
